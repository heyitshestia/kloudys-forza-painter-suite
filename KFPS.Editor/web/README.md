...
See the [source package](../README.md) and [validation guide](../docs/VALIDATION.md)
for development and test requirements.
...
keyboard shortcuts. A stalled explicit save has bounded waits and retains unsaved
work. If the reply is lost after writing, the editor checks the save receipt before
offering a retry, so a successful save is not silently duplicated.
