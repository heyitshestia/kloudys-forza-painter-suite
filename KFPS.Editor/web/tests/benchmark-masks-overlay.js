async (page) => {
  ...
  return page.evaluate(async () => {
    ...
    await editorReference.loadOverlayImageFromUrl(source.toDataURL(), "Synthetic mask reference.png", { layeredState: null });
    ...
    for (let index = 0; index < 30; index += 1) {
      ...
      if (!editorRenderer.hybridRenderNow()) throw new Error("Hybrid renderer did not run with masks and an overlay.");
    ...
    return {
      ...
      hybridAllowed: editorRenderer.hybridShouldUse(vinylObjects()),
